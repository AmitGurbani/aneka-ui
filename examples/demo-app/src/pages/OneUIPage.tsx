  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-6xl mx-auto">
        <div className="mb-12">
          <h1 className="text-5xl font-bold mb-4">Samsung One UI</h1>
        ...
        <Card className="mb-12">
          <CardHeader>
            ...
            <CardDescription>Key properties of Samsung One UI components</CardDescription>
          </CardHeader>
          ...
          <div className="grid gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Notice the bold text and prominent shadows</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>One UI buttons have extra padding for easier tapping</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Click to see the enhanced shadow effect</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-wrap gap-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>16px radius with 2px borders and prominent shadows</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Samsung One UI cards feature notably rounded corners (16px), thicker borders (2px),
                  and more generous padding for a bold, confident appearance.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  All elements maintain One UI's signature generous spacing for better readability
        ...
        <section className="mb-12">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Bold text with pill shape and 2px borders</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <section className="mb-12">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Prominent shadow with 250ms animation</CardDescription>
            </CardHeader>
            <CardContent>
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      This dialog follows One UI principles with 16px border radius,
                      prominent shadows, and generous 2rem padding.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="py-4">
                    <p className="text-sm text-muted-foreground">
                      Notice the bold, confident design with ample spacing that makes
                      content easy to read and interact with.
                    </p>
                  </div>
                  <DialogFooter>
        ...
        <section className="mb-12">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Hover for larger tooltips with prominent styling</CardDescription>
            </CardHeader>
            <CardContent>
              <TooltipProvider>
                <div className="flex flex-wrap gap-4">
