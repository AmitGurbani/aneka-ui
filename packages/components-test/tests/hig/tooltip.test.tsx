...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from "../../src/hig/tooltip";

describe("Apple HIG Tooltip", () => {
  ...
  describe("TooltipContent Styling", () => {
    it("should have Apple HIG primary colors", async () => {
    ...
    it("should have 6px border radius for Apple HIG", async () => {
      const user = userEvent.setup();
    ...
    it("should have Apple HIG shadow", async () => {
      const user = userEvent.setup();
