...
import { Badge } from "../../src/hig/badge";

describe("Apple HIG Badge", () => {
  describe("Rendering", () => {
  ...
  describe("Apple HIG Styling", () => {
    it("should have normal case text styling (not uppercase)", () => {
      render(<Badge>Apple Badge</Badge>);
      const badge = screen.getByText("Apple Badge");
      expect(badge).not.toHaveClass("uppercase");
      expect(badge).toHaveClass("tracking-tight");
    });

    it("should have rounded-md shape (6px radius)", () => {
    ...
    it("should have subtle shadow on filled variants", () => {
      ...
      expect(badge.className).toContain("shadow-[0_1px_3px_rgba(0,0,0,0.08)]");
    });
