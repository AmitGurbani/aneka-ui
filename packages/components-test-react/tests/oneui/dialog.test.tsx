...
import {
  ...
  DialogTitle,
  DialogTrigger,
} from "../../src/oneui/dialog";

describe("Samsung One UI Dialog", () => {
  ...
  describe("DialogContent", () => {
    ...
    it("should have Samsung One UI styling", () => {
      render(
        <Dialog open>
    ...
    it("should have Samsung One UI shadow", () => {
      render(
        <Dialog open>
          <DialogContent data-testid="dialog-content">
            <DialogTitle>Title</DialogTitle>
    ...
    it("should have 250ms animation duration", () => {
      ...
      const content = screen.getByTestId("dialog-content");
      expect(content).toHaveClass("duration-250");
    });
